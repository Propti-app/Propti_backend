...
#     tenant_id = Column(Integer, ForeignKey("tenants.tenant_id"))
#     message = Column(String)
#     medium = Column(Enum(PaymentMethod), default=PaymentMethod.CASH)  # Reuse enum for simplicity
#     sent_at = Column(DateTime, server_default=text("CURRENT_TIMESTAMP"))
#     status = Column(Enum(ReminderStatus), default=ReminderStatus.SENT)
#     created_at = Column(DateTime, server_default=text("CURRENT_TIMESTAMP"))
#     tenant = relationship("Tenant", back_populates="reminders")
...
#     email = Column(String, nullable=True)
#     balance = Column(Float)
#     archived_at = Column(DateTime, server_default="CURRENT_TIMESTAMP")
...
#     message = Column(String)
#     medium = Column(Enum(PaymentMethod), default=PaymentMethod.CASH)  # Reuse enum for simplicity
#     sent_at = Column(DateTime, server_default="CURRENT_TIMESTAMP")
#     status = Column(Enum(ReminderStatus), default=ReminderStatus.SENT)
#     created_at = Column(DateTime, server_default="CURRENT_TIMESTAMP")
#     tenant = relationship("Tenant", back_populates="reminders")
...
# from sqlalchemy import Column, Integer, String, DateTime, Boolean, JSON, Float, Enum, ForeignKey
...
#     __tablename__ = "properties"
#     property_id = Column(Integer, primary_key=True, index=True)
#     landlord_id = Column(Integer, index=True)
#     name = Column(String)
#     photo = Column(String, nullable=True)
#     created_at = Column(DateTime(timezone=True), server_default=func.now())
#     updated_at = Column(DateTime(timezone=True), onupdate=func.now())
...
#     __tablename__ = "rooms"
#     room_id = Column(Integer, primary_key=True, index=True)
#     property_id = Column(Integer, ForeignKey("properties.property_id"), index=True)
#     room_number = Column(String)
#     rent_amount = Column(Float)
#     due_date = Column(Integer)  # Day of month (e.g., 5 for 5th)
#     payment_status = Column(Enum(PaymentStatus), default=PaymentStatus.OVERDUE)
#     updated_at = Column(DateTime(timezone=True), onupdate=func.now())
...
#     __tablename__ = "payments"
#     payment_id = Column(Integer, primary_key=True, index=True)
#     rent_cycle_id = Column(Integer, ForeignKey("rent_cycles.rent_cycle_id"), index=True)
#     tenant_id = Column(Integer, ForeignKey("tenants.tenant_id"))
#     amount = Column(Float)
...
# from sqlalchemy import Column, Integer, String, DateTime, Boolean, JSON, Float, Enum
# from sqlalchemy.sql import func
# from .database import Base
# import enum
...
#     photo = Column(String, nullable=True)
#     id_card_number = Column(String, nullable=True)
#     assigned_room_id = Column(Integer, nullable=True)
#     balance = Column(Float, default=0.0)
#     created_at = Column(DateTime(timezone=True), server_default=func.now())
#     updated_at = Column(DateTime(timezone=True), onupdate=func.now())
#     is_active = Column(Boolean, default=True)
