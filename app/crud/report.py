# app/crud/report.py - COMPLETE VERSION WITH BACKWARD COMPATIBILITY
...
def get_dashboard(db: Session, landlord_id: int):
    """
    Legacy dashboard function - kept for backward compatibility
    Returns basic property and room metrics
    """
